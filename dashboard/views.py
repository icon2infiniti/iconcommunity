...
def index(request, template='dashboard/dashboard.html', extra_context=None):
    ...
    average_sentiment_calc_24h = 1#round(socialinfo.average_sentiment_calc_24h / 5 * 100)
    average_sentiment_calc_24h_percent = -99#socialinfo.average_sentiment_calc_24h_percent - 100
